...
fetch(
  `https://api.openweathermap.org/data/2.5/weather?q=jalandhar&appid=49cb8945a50da0a2becc8eedc24d99f1`
)
  .then((res) => res.json())
  .then((data) => {
    let article = data;
    ...
    max_min.innerText =
      Math.floor(article.main.temp_max - 273) +
      '°C' +
      '/' +
      Math.floor(article.main.temp_min - 273) +
      '°C';
